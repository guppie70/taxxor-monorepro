...
#pragma warning disable S6562 // Always set the "DateTimeKind" when creating new "DateTime" instances
    // TO DO: review the above warning
    ...
    public static class DateTimeExtensions
    {
        ...
        {
            DateTime dateShifted = date.AddMonths(quarters * 3);
        ...
        public static int ElapsedMonths(this DateTime date1, DateTime date2)
        {
            ...
            int eMonths = laterDate.Month - earlierDate.Month + 12 * (laterDate.Year - earlierDate.Year) -
