...
namespace FrameworkLibrary
{
    ...
    /// </summary>
    public static class FrameworkStream
    {
        ...
        public static byte[] ConvertStreamToByteArray(Stream input)
        {
            ...
            using MemoryStream ms = streamLength.HasValue && streamLength.Value <= int.MaxValue
        ...
        public static string RenderStreamHash<T>(Stream stream) where T : HashAlgorithm
        {
            ...
            MethodInfo? create = typeof(T).GetMethod("Create", []);
