...
namespace Taxxor.Project
{
    ...
    public class Program
    {
        ...
        {
            Console.WriteLine($"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n** {(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"))} - Starting Application **\n");

            // Start the web application
            Host.CreateDefaultBuilder(args)
                .ConfigureLogging(logBuilder =>
                {
                    logBuilder.AddFileAndConsoleLoggers();
                })
                .ConfigureWebHostDefaults(webBuilder =>
                {
                    ...
                    //     options.ListenLocalhost(4812, o => o.Protocols = HttpProtocols.Http2);
                    // });
