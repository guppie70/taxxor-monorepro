...
namespace Taxxor.Project
{
    ...
    public class Startup : ProjectLogic
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddGrpcClient<FilingHierarchyService.FilingHierarchyServiceClient>(o =>
            {
                o.Address = new Uri("https://documentstore:4813");
            });

            services.AddGrpcClient<FilingDataUtilityService.FilingDataUtilityServiceClient>(o =>
            {
                o.Address = new Uri("https://documentstore:4813");
            });

            services.AddGrpcClient<GeneratedReportsRepositoryService.GeneratedReportsRepositoryServiceClient>(o =>
            {
                o.Address = new Uri("https://documentstore:4813");
            });
