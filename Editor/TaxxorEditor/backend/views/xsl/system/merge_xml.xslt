...
<xslt:transform version="1.0" xmlns:xslt="http://www.w3.org/1999/XSL/Transform" xmlns:m="http://informatik.hu-berlin.de/merge" exclude-result-prefixes="m">


	<!-- Normalize the contents of text, comment, and processing-instruction nodes before comparing? Default: yes -->
				...
				<xslt:choose>
					...
					<xslt:when test="$diff-first='!'">
						...
						<xslt:choose>
							...
							<!-- $first1 is a text node and replace mode wasactivated -->
